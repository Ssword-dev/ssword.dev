...
function SidebarProvider({
  ...
  stateCookieName = "sidebar_state",
  stateCookieMaxAge = 60 * 60 * 24 * 7,
  sidebarWidth = "16rem",
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      document.cookie =
        (document.cookie
          ? `${document.cookie + document.cookie.at(-1) === ";" ? "" : ";"}`
          : "") +
        `${stateCookieName}=${openState}; path=/; max-age=${stateCookieMaxAge}`;
    },
    [setOpenProp, open, stateCookieName, stateCookieMaxAge],
  );
